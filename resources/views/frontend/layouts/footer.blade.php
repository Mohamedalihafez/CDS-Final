              ...
              <div class="container">
                 <div class="row">
                    <div class="col-md-8 offset-md-2">
                       <p>© 2022 All Rights Reserved. Design by Corona Detection System</p>
                    </div>
                 </div>
              </div>
           </div>
...
<script src="{{asset('assets/Js2/bootstrap.js')}}"></script>
<script src="{{asset('assets/Js2/custom.js')}}"></script>
<script src="{{asset('assets/Js2/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/Js2/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{asset('assets/Js2/jquery.min.js')}}"></script>
<script src="{{asset('assets/Js2/jquery.validate.js')}}"></script>
<script src="{{asset('assets/Js2/owl.carousel.min.js')}}"></script>
<script src="{{asset('assets/Js2/slider-setting.js')}}"></script>
...
<script src="{{asset('assets/frontend/js/sequence.js')}}"></script>
<script src="{{asset('assets/frontend/js/sequence-theme.modern-slide-in.js')}}"></script>

<script type="text/javascript" src="{{asset('assets/frontend/js/jquery.simpleGallery.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/frontend/js/jquery.simpleLens.js')}}"></script>

<script type="text/javascript" src="{{asset('assets/frontend/js/slick.js')}}"></script>

<script type="text/javascript" src="{{asset('assets/frontend/js/nouislider.js')}}"></script>

<script src="{{asset('assets/frontend/js/sweet.js')}}"></script>
<script src="{{asset('assets/frontend/js/custom.js')}}"></script>
<script src="{{asset('assets/chat/custom.js')}}"></script>
<script src="{{asset('assets/frontend/js/CustomAjax.js')}}"></script>
<script>
